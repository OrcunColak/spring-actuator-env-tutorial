package com.colak.springactuatorenvtutorial.sanitizer;
...
@Component
public class EnvActuatorSanitizer implements SanitizingFunction {
    ...
    public EnvActuatorSanitizer(@Value("${management.endpoint.additionalKeysToSanitize:}") List<String> additionalKeys) {
